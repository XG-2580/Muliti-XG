...
module.exports = {
    ...
    run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
      ...
      const { guild } = member;
		try{
      let milratodc = client.guilds.cache.get("861490922873028608")
      let milratomembers = await milratodc.members.fetch();
      let partnercount = milratomembers.filter(m => m.roles.cache.has("861490922989551637"))
      ...
      .setColor(es.color)
      .setAuthor(client.la[ls].cmds.info.botfaq.menuembed.title, client.user.displayAvatarURL(), "https://discord.gg/PTGzEysqjf")
