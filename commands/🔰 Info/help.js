  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      if (args[0]) {
        ...
        let button_tutorial = new MessageButton().setStyle('LINK').setEmoji("840260133686870036").setLabel("Support Server").setURL("https://discord.gg/PTGzEysqjf")
        let menuOptions = [
          {
            label: "Overview",
            value: "Overview",
